...
/**
 * LoggingAspect - AOP-based logging for ConnectSphere Like Service
 *
 * Exact same structure as post-service and comment-service LoggingAspect.
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.connectsphere.like.controller..*(..))")
    public void controllerLayer() {}

    @Pointcut("execution(* com.connectsphere.like.service..*(..))")
    public void serviceLayer() {}

    @Pointcut("execution(* com.connectsphere.like.repository..*(..))")
