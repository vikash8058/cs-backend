...
/**
 * LoggingAspect - AOP-based logging for ConnectSphere Follow Service
 *
 * Exact same structure as all other ConnectSphere services.
 */
@Aspect
@Component
@Slf4j
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.connectsphere.follow.controller..*(..))")
    public void controllerLayer() {}

    @Pointcut("execution(* com.connectsphere.follow.service..*(..))")
    public void serviceLayer() {}

    @Pointcut("execution(* com.connectsphere.follow.repository..*(..))")
