...
/**
 * LoggingAspect - AOP-based logging for ConnectSphere Payment Service
 */
@Aspect
@Component
@Slf4j
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.connectsphere.payment.controller..*(..))")
    public void controllerLayer() {}

    @Pointcut("execution(* com.connectsphere.payment.service..*(..))")
    public void serviceLayer() {}

    @Pointcut("execution(* com.connectsphere.payment.repository..*(..))")
