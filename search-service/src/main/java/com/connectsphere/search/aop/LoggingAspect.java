...
/**
 * LoggingAspect - AOP-based logging for ConnectSphere Search Service
 *
 * Exact same structure as like-service, comment-service, follow-service LoggingAspect.
 * Logs method entry, exit, exceptions, and execution time across all layers.
 */
@Aspect
@Component
@Slf4j
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.connectsphere.search.controller..*(..))")
    public void controllerLayer() {}

    @Pointcut("execution(* com.connectsphere.search.service..*(..))")
    public void serviceLayer() {}

    @Pointcut("execution(* com.connectsphere.search.repository..*(..))")
